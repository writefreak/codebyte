...
const Description = ({ className }: Props) => {
  return (
    <div className={cn("", className)}>
      <div>
        <Link href={"/#blogs"}>
          <h3 className=" font-montserrat text-2xl sm:text-3xl pt-14 sm:py-9 hover:underline hover:decoration-2">
            Dive into our courses and and join the conversation—your insights
            and ideas matter.
          </h3>
        </Link>

        <p className="font-montserrat text-sm font-light hidden sm:block">
        ...
        <h3 className="font-montserrat text-lg sm:text-xl pt-10 sm:pt-8">
        ...
        <a href="#">
          <div className="flex items-center gap-2 pt-5 hover:underline hover:decoration-2">
            ...
            <p className="font-inter font-light ">codebyte@gmail.com</p>
          </div>
        </a>
      </div>
    </div>
